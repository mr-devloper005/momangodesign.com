export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'momangodesign',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Momangodesign',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'momangodesign.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://momangodesign.com',
