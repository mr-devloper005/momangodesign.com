...
export const adSkin: AdSkin = {
  ...
  shadow: '0 8px 30px rgba(253,121,121,0.08)',
  background: '#FFCDC9',
  labelClassName: 'bg-[#FD7979] text-white',
}

// Optional per-slot overrides — adjust only where you need to.
export const adSkinBySlot: Partial<Record<string, AdSkin>> = {
  sidebar: { radius: '12px', shadow: 'none', border: '1px solid rgba(253,121,121,0.2)' },
  popup: { radius: '24px' },
  header: { radius: '20px', background: '#FEEAC9' },
}
